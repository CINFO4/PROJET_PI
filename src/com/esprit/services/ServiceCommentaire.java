...
public class ServiceCommentaire implements IServices<Commentaire> {
    ...
    public void ajouter(Commentaire C) {
        try {
            ...
            sm.sendMail(serviceForum.getUserEmailByForumId(C.getId_forum()), serviceForum.getUserNameByForumId(C.getId_user()) + " a Commenté sur votre forum", "Bonjour \n" + serviceForum.getUserNameByForumId(C.getId_forum()) + "\n\nVous avez un nouveau commentaire sur votre forum par" + serviceForum.getUserNameByForumId(C.getId_user()) + ".\n\\n" +
         "Le contenu du commentaire est " + replaceBadWords(C.getContenu()) +"\\n\\nCordialement\\nPI-Dev" );
                    
//            String senderEmail = "findjobreply@gmail.com";
//            String senderPassword = "pjwzsenustgioixb";
//
